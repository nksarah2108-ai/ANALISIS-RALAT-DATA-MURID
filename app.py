...
# 2. PAUTAN LOGO (Guna direct link Google Drive yang betul)
# ID Fail: 1XV1CIEWhms8jHqJGOKpSluqr7cxtSWrv
...
try:
    ...
    # --- KEDUDUKAN LOGO TENGAH (MENGGUNAKAN COLUMNS) ---
    col_1, col_2, col_logo, col_4, col_5 = st.columns([1, 1, 1.2, 1, 1])
    with col_logo:
        st.image(logo_url, use_container_width=True)

    # TAJUK (Betul-betul bawah logo)
